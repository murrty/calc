...
namespace calc {
    public partial class frmMain : Form {
        ...
        public frmMain() {
            InitializeComponent();
            mSystemCalculator.Visible = File.Exists("%SystemRoot%/system32/calcsys.exe");
        ...
        private void GetValue() {
            ...
            DataValue = IntegralConversions.GetString(IntegralConversions.GetValue(DataBytes, DataType), mThousandths.Checked);
        ...
        private void CheckKeyData() {
            ...
            //DataHex = DataBytes[0] != 0x0 ? DataBytes[7].ToString("X") : "00";
            //DataHex = (DataBytes[1] != 0x0 ? DataBytes[6].ToString("X") : "00") + DataHex;
            //DataHex = (DataBytes[2] != 0x0 ? DataBytes[5].ToString("X") : "00") + DataHex;
            //DataHex = (DataBytes[3] != 0x0 ? DataBytes[4].ToString("X") : "00") + DataHex;
            //DataHex = (DataBytes[4] != 0x0 ? DataBytes[3].ToString("X") : "00") + DataHex;
            //DataHex = (DataBytes[5] != 0x0 ? DataBytes[2].ToString("X") : "00") + DataHex;
            //DataHex = (DataBytes[6] != 0x0 ? DataBytes[1].ToString("X") : "00") + DataHex;
            //DataHex = (DataBytes[7] != 0x0 ? DataBytes[0].ToString("X") : "00") + DataHex;

            //DataHex = DataHex.TrimStart('0');
        ...
        private void PerformCalculation() {
            ...
            switch (DataType) {
                case IntegerType.Byte: {
                    ...
                    DataBytes[0] = CalculationBytes[0];
                ...
                case IntegerType.Int16: {
                    ...
                    CalculationBytes = BitConverter.GetBytes(Result);
                    DataBytes[0] = CalculationBytes[0];
                    DataBytes[1] = CalculationBytes[1];
                    CalculationBytes = new byte[8];
                    if (mBigEndian.Checked) {
                        bcBytes8.Byte = DataBytes[0];
                        bcBytes7.Byte = DataBytes[1];
                ...
                case IntegerType.Int32: {
                    ...
                    DataBytes[0] = CalculationBytes[0];
                    DataBytes[1] = CalculationBytes[1];
                    DataBytes[2] = CalculationBytes[2];
                    DataBytes[3] = CalculationBytes[3];
                    CalculationBytes = new byte[8];
                    if (mBigEndian.Checked) {
                        bcBytes8.Byte = DataBytes[0];
                        bcBytes7.Byte = DataBytes[1];
                ...
                case IntegerType.Int64: {
                    ...
                    DataBytes[2] = CalculationBytes[2];
                    DataBytes[3] = CalculationBytes[3];
                    DataBytes[4] = CalculationBytes[4];
                    DataBytes[5] = CalculationBytes[5];
                    DataBytes[6] = CalculationBytes[6];
                    DataBytes[7] = CalculationBytes[7];
                    CalculationBytes = new byte[8];
                    if (mBigEndian.Checked) {
                        bcBytes8.Byte = DataBytes[0];
                        bcBytes7.Byte = DataBytes[1];
