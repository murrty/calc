    ...
    internal static class IntegralConversions {
        ...
        public static string GetString(object data, bool ThousandsthSeparator) {
            return data switch {
                ...
                Int16 val => val.ToString(ThousandsthSeparator ? "#,##0" : ""),
                UInt16 val => val.ToString(ThousandsthSeparator ? "#,##0" : ""),
                Int32 val => val.ToString(ThousandsthSeparator ? "#,##0" : ""),
                UInt32 val => val.ToString(ThousandsthSeparator ? "#,##0" : ""),
                Single val => val.ToString(ThousandsthSeparator ? "#,##0.#########" : ""),
                Int64 val => val.ToString(ThousandsthSeparator ? "#,##0" : ""),
                UInt64 val => val.ToString(ThousandsthSeparator ? "#,##0" : ""),
                Double val => val.ToString(ThousandsthSeparator ? "#,##0.###################" : ""),
        ...
        public static string GetString(object data, string formatting = null) {
            return data switch {
                ...
                Int16 val => val.ToString(formatting ?? "#,##0"),
                UInt16 val => val.ToString(formatting ?? "#,##0"),
                Int32 val => val.ToString(formatting ?? "#,##0"),
                UInt32 val => val.ToString(formatting ?? "#,##0"),
                Single val => val.ToString(formatting ?? "#,##0.#########"),
                Int64 val => val.ToString(formatting ?? "#,##0"),
                UInt64 val => val.ToString(formatting ?? "#,##0"),
                Double val => val.ToString(formatting ?? "#,##0.###################"),
                _ => throw new ArgumentException(nameof(data)),
            };
        }
